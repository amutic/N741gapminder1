...
### Answer Homework 01 Exercise - Task 1
Modify the sentence to include standard deviation, median, and sample size for life expectancy.
...
### Answer Homework 01 Exercise - Task 2
To modify the code to include the mean and standard deviation for life expectancy
First mean.
```{r}
...
### Answer Homework 01 Exercise - Task 3
First, modify the R code chunk above to make plot using "y" aesthetic GDP per  capita.
```{r}
library(ggplot2)
...
Next,  modify the R code chunk again by changing "y" aesthetic to population to make new plot.
```{r}
library(ggplot2)
...
Let's look at a bubble plot for Americas and Asia in 1992.
...
My Github repository is located at [https://github.com/amutic/N741gapminder1](https://github.com/amutic/N741gapminder1).
